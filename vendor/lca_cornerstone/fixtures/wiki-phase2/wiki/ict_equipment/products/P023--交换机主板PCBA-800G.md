...
id: P023
node_type: product
display_name: "交换机主板PCBA, 800G"
boundary: foreground
facets: {equipment_class: "compute_card", integration_level: "subsystem", compute_type: "networking_800g", form_factor: "na", product_subtype: "switch_mainboard"}
produced_by: [A024]
consumed_by: [A014]
external: {cpc: "4529", hs: "8473.30"}
confidence: core
provenance_refs: [hs, isic, ku-hiqlcd-public-ict-2026]
spine_hash: "86e6cd15c228"
schema_version: wiki-v1
sigil: "sigil/P023.svg"
body_status: draft
...
该节点表示用于800G交换设备的主板PCBA子系统，而非完整网络交换机或可插拔光模块。 〔未核实·模型回忆〕
...
参考流宜定义为一块完成测试并可交付整机装配的800G交换机主板PCBA，交接点设在板级制造完成之后。 〔未核实·模型回忆〕 [^internal-review]

## 规格与相邻节点区分

本节点按networking_800g计算类型区分于100G/400G交换机主板PCBA，带宽等级是两节点的身份刻面。 〔未核实·模型回忆〕 [^internal-review]

## 在系统中的角色

该主板PCBA作为800G交换设备的上游板级子系统，被用于后续交换机装配活动。 〔未核实·模型回忆〕 [^internal-review]

## 分类与适用范围

该节点适用于800G以太网交换设备的主板PCBA，不覆盖100G/400G主板、完整交换机或独立网络接口卡。 〔未核实·模型回忆〕 [^internal-review]

## 节点特定采集字段

采集应至少记录板级物料构成、芯片和端口配置、制造与测试工序，以及800G网络规格。 〔未核实·模型回忆〕 [^internal-review]
...
```mermaid
flowchart LR
  A024(("SMT贴装, 回流焊接 | 交换机主板PCBA, 800G")) ==> P023
  P023["交换机主板PCBA, 800G"]
  P023 --> A014(("系统集成, 整机总装 | 网络交换机, 800G, 2U"))
```
